...
async def main():
    ...
    gates = [
        ...
        ("profitLock", f"trigger={cfg.get('profitLockTriggerUsdt', 0.50)} giveback={cfg.get('profitLockMaxGivebackUsdt', 0.30)}"),
        ("retraceFloor", f"rate={cfg.get('profitLockRetraceFloorRatePct', 0.70)}%"),
        ("breakevenGuard", f"trigger={cfg.get('profitLockBreakevenTriggerUsdt', 0.50)} floor={cfg.get('profitLockBreakevenFloorUsdt', 0.25)}"),
