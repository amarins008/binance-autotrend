...
This project is indexed by GitNexus as **Binance autotrend** (1397 symbols, 1791 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
