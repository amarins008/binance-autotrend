...
class AutoTradeStartRequest(BaseModel):
    ...
    marketContextWatcherEnabled: bool = False
    marketContextWatcherIntervalSec: int = Field(default=60, ge=45, le=3600)
    marketContextWatcherMaxSymbols: int = Field(default=6, ge=1, le=8)
    marketContextWatcherExchange: str = "BINANCE"
    marketContextWatcherTimeframe: str = "1h"
    marketContextWatcherMcpPort: int = Field(default=8877, ge=1024, le=65535)
    marketContextWatcherMcpStartupSec: int = Field(default=12, ge=8, le=300)
    marketContextWatcherMcpCallTimeoutSec: int = Field(default=12, ge=8, le=120)
    marketContextWatcherBatchTimeoutSec: int = Field(default=45, ge=30, le=300)
    guardianMarketContextContextEnabled: bool = False
    guardianMarketContextContextMaxAgeSec: int = Field(default=420, ge=60, le=3600)
    guardianMarketContextTightenSlPct: float = Field(default=0.22, ge=0.05, le=1.0)
    guardianMarketContextMinProfitLockUsdt: float = Field(default=0.06, ge=0.0, le=10.0)
    guardianMarketContextBlockTpExtension: bool = True
    entryMarketContextGateEnabled: bool = True
    entryMarketContextGateMaxAgeSec: int = Field(default=420, ge=60, le=3600)
    entryMarketContextBlockContradiction: bool = True
    entryMarketContextBlockWeakSignal: bool = True
    entryMarketContextWeakExtraConfidence: float = Field(default=0.03, ge=0.0, le=0.2)
    entryMarketContextConfirmConfidenceBoost: float = Field(default=0.015, ge=0.0, le=0.2)
