...
class TestSupervisorRegimeReview(unittest.TestCase):
    ...
    def test_external_signal_data_failure_pauses_entries_and_reports_cmux(self):
        prev_agents = main.AUTO_TRADE.get("hermesAgents")
        prev_tune = main.AUTO_TRADE.get("supervisorAutoTune")
        prev_signals = main.AUTO_TRADE.get("supervisorExternalSignals")
        ...
        try:
            ...
            self.assertTrue(cfg["entryMarketContextBlockWeakSignal"])
            self.assertEqual(cfg["scanGuardedFallbackConfRelax"], 0.04)
            self.assertGreater(main.AUTO_TRADE["pauseUntil"], 0)
            self.assertEqual(out["cmuxActionReport"]["action"], "pause_new_entries")
    ...
    def test_marketcontext_watcher_recovery_clears_data_failure_pause(self):
        prev_agents = main.AUTO_TRADE.get("hermesAgents")
        prev_tune = main.AUTO_TRADE.get("supervisorAutoTune")
        prev_signals = main.AUTO_TRADE.get("supervisorExternalSignals")
        prev_config = main.AUTO_TRADE.get("config")
        prev_positions = main.AUTO_TRADE.get("openLivePositions")
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
        ...
        prev_pause = main.AUTO_TRADE.get("pauseUntil")
        prev_guard = main.AUTO_TRADE.get("externalSignalGuard")
        prev_report = main.AUTO_TRADE.get("lastCmuxReport")
        ...
        try:
            ...
            main.AUTO_TRADE["supervisorAutoTune"] = {}
            main.AUTO_TRADE["supervisorExternalSignals"] = []
            main.AUTO_TRADE["config"] = {"marketContextWatcherEnabled": True, "marketContextWatcherMaxSymbols": 1}
            ...
            with mock.patch.object(main, "_persist_autotrade_snapshot", return_value=None):
                out = asyncio.run(main._marketcontext_signal_watch_once(fake_provider))

            self.assertTrue(out["ok"])
            self.assertEqual(main.AUTO_TRADE["pauseUntil"], 0)
            self.assertEqual(out["cmuxActionReport"]["type"], "marketcontext_mcp_recovered")
            self.assertEqual(main.AUTO_TRADE["lastCmuxReport"]["action"], "clear_data_failure_entry_pause")
        finally:
            main.AUTO_TRADE["hermesAgents"] = prev_agents
            main.AUTO_TRADE["supervisorAutoTune"] = prev_tune
            main.AUTO_TRADE["supervisorExternalSignals"] = prev_signals
            main.AUTO_TRADE["config"] = prev_config
            main.AUTO_TRADE["openLivePositions"] = prev_positions
            main.AUTO_TRADE["marketContextWatcher"] = prev_watcher
            ...
            if prev_report is None:
                main.AUTO_TRADE.pop("lastCmuxReport", None)
            else:
                main.AUTO_TRADE["lastCmuxReport"] = prev_report

    def test_marketcontext_watcher_open_position_submits_supervisor_risk_tune(self):
        prev_agents = main.AUTO_TRADE.get("hermesAgents")
        prev_tune = main.AUTO_TRADE.get("supervisorAutoTune")
        prev_signals = main.AUTO_TRADE.get("supervisorExternalSignals")
        prev_config = main.AUTO_TRADE.get("config")
        ...
        try:
            ...
            main.AUTO_TRADE["config"] = {
                ...
                "marketContextWatcherMaxSymbols": 3,
                "supervisorSizeMultiplier": 1.0,
                "supervisorSizeMinMultiplier": 0.5,
                "maxOpenPositions": 5,
                "minConfidence": 0.80,
            ...
            self.assertEqual(main.AUTO_TRADE["marketContextWatcher"]["supervisorResult"]["reason"], "marketcontext_mcp_internal")
        finally:
            main.AUTO_TRADE["hermesAgents"] = prev_agents
            main.AUTO_TRADE["supervisorAutoTune"] = prev_tune
            main.AUTO_TRADE["supervisorExternalSignals"] = prev_signals
    ...
    def test_marketcontext_watcher_uses_live_profit_locks_as_open_positions(self):
        state = {
            "openLivePositions": [],
            "liveProfitLocks": {
                "ETHUSDT": {
        ...
        targets = main._marketcontext_target_symbols(state, {"marketContextWatcherMaxSymbols": 3})
    ...
    def test_marketcontext_watcher_pending_breakout_relaxes_scan_only(self):
        prev_tune = main.AUTO_TRADE.get("supervisorAutoTune")
        prev_signals = main.AUTO_TRADE.get("supervisorExternalSignals")
        prev_config = main.AUTO_TRADE.get("config")
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
    ...
    def test_marketcontext_watcher_pending_contradiction_creates_entry_gate_finding(self):
        ...
        findings = main._marketcontext_findings_from_results(targets, results, {})
    ...
    def test_entry_marketcontext_context_blocks_pending_reversal(self):
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
        try:
            main.AUTO_TRADE["marketContextWatcher"] = {
            ...
            out = main._entry_marketcontext_context(
                "ENAUSDT",
                "LONG",
                {"entryMarketContextGateEnabled": True, "entryMarketContextBlockContradiction": True},
            )
    ...
    def test_entry_marketcontext_context_boosts_confirmed_pending_breakout(self):
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
        try:
            main.AUTO_TRADE["marketContextWatcher"] = {
                "updatedAt": int(time.time()),
            ...
            out = main._entry_marketcontext_context(
                "ENAUSDT",
                "LONG",
                {"entryMarketContextGateEnabled": True, "entryMarketContextConfirmConfidenceBoost": 0.02},
            )
    ...
    def test_guardian_marketcontext_context_tightens_long_sl_and_blocks_tp_extension(self):
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
        try:
            main.AUTO_TRADE["marketContextWatcher"] = {
                "updatedAt": int(time.time()),
            ...
            out = main._guardian_marketcontext_context(
                "ETHUSDT",
                "LONG",
                mark=100.0,
                entry=98.0,
                ...
                tp=104.0,
                cfg={
                    "guardianMarketContextContextEnabled": True,
                    "guardianMarketContextTightenSlPct": 0.2,
                    "guardianMarketContextMinProfitLockUsdt": 0.5,
                    "guardianMarketContextBlockTpExtension": True,
                },
            )
    ...
    def test_guardian_marketcontext_context_ignores_stale_signal(self):
        prev_watcher = main.AUTO_TRADE.get("marketContextWatcher")
        try:
            main.AUTO_TRADE["marketContextWatcher"] = {
            ...
            out = main._guardian_marketcontext_context(
                ...
                sl=95.0,
                tp=104.0,
                cfg={"guardianMarketContextContextMaxAgeSec": 60},
            )
