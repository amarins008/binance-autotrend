...
def apply_autotrade_defaults(cfg: dict | None, *, preset: str | None = "pro") -> dict:
    ...
    out.setdefault("marketContextWatcherEnabled", True)
    out.setdefault("marketContextWatcherIntervalSec", 60)
    out.setdefault("marketContextWatcherMaxSymbols", 6)
    out.setdefault("marketContextWatcherExchange", "BINANCE")
    out.setdefault("marketContextWatcherTimeframe", "1h")
    out.setdefault("marketContextWatcherMcpPort", 8877)
    out.setdefault("marketContextWatcherMcpStartupSec", 12)
    out.setdefault("marketContextWatcherMcpCallTimeoutSec", 12)
    out.setdefault("marketContextWatcherBatchTimeoutSec", 45)
    out.setdefault("marketContextWatcherUseMtf", False)
    out.setdefault("marketContextWatcherUseVolume", False)
    out.setdefault("marketContextWatcherSkipDeniedSymbols", True)
    out.setdefault("guardianMarketContextContextEnabled", True)
    out.setdefault("guardianMarketContextContextMaxAgeSec", 420)
    out.setdefault("guardianMarketContextTightenSlPct", 0.22)
    out.setdefault("guardianMarketContextMinProfitLockUsdt", 0.06)
    out.setdefault("guardianMarketContextBlockTpExtension", True)
    out.setdefault("entryMarketContextGateEnabled", True)
    out.setdefault("entryMarketContextGateMaxAgeSec", 420)
    out.setdefault("entryMarketContextBlockContradiction", True)
    out.setdefault("entryMarketContextBlockWeakSignal", True)
    out.setdefault("entryMarketContextWeakExtraConfidence", 0.03)
    out.setdefault("entryMarketContextConfirmConfidenceBoost", 0.015)
    out.setdefault(
        "marketContextWatcherCommand",
        [
